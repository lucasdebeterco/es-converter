...
(function (global, factory) {
  (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global = global || self, global.Sweetalert2 = factory());
})(undefined, function () {
  'use strict';
  ...
  var warn = function warn(message) {
    console.warn("".concat(consolePrefix, " ").concat((typeof message === 'undefined' ? 'undefined' : _typeof(message)) === 'object' ? message.join(' ') : message));
  };
  /**
  ...
  var checkAndSetInputValue = function checkAndSetInputValue(input, inputValue) {
    if (['string', 'number'].includes(typeof inputValue === 'undefined' ? 'undefined' : _typeof(inputValue))) {
      input.value = "".concat(inputValue);
    } else if (!isPromise(inputValue)) {
      warn("Unexpected type of inputValue! Expected \"string\", \"number\" or \"Promise\", got \"".concat(typeof inputValue === 'undefined' ? 'undefined' : _typeof(inputValue), "\""));
    }
  };
  ...
  var setColor = function setColor(icon, params) {
    ...
    var _arr = ['.swal2-success-line-tip', '.swal2-success-line-long', '.swal2-x-mark-line-left', '.swal2-x-mark-line-right'];
  ...
  var formatInputOptions = function formatInputOptions(inputOptions) {
    ...
    if (typeof Map !== 'undefined' && inputOptions instanceof Map) {
      inputOptions.forEach(function (value, key) {
        ...
        if ((typeof valueFormatted === 'undefined' ? 'undefined' : _typeof(valueFormatted)) === 'object') {
          // case of <optgroup>
  ...
  var isJqueryElement = function isJqueryElement(elem) {
    return (typeof elem === 'undefined' ? 'undefined' : _typeof(elem)) === 'object' && elem.jquery;
  };
    ...
    if (_typeof(args[0]) === 'object' && !isElement(args[0])) {
      ...
      ['title', 'html', 'icon'].forEach(function (name, index) {
        ...
        if (typeof arg === 'string' || isElement(arg)) {
          ...
          error("Unexpected type of ".concat(name, "! Expected \"string\" or \"Element\", got ").concat(typeof arg === 'undefined' ? 'undefined' : _typeof(arg)));
        }
      });
    }
  ...
  function mixin(mixinParams) {
    var MixinSwal = function (_ref) {
      _inherits(MixinSwal, _ref);
      ...
      _createClass(MixinSwal, [{
        ...
        value: function _main(params, priorityMixinParams) {
          return _get(MixinSwal.prototype.__proto__ || Object.getPrototypeOf(MixinSwal.prototype), '_main', this).call(this, params, Object.assign({}, mixinParams, priorityMixinParams));
        }
      }]);
...
if (typeof undefined !== 'undefined' && undefined.Sweetalert2) {
